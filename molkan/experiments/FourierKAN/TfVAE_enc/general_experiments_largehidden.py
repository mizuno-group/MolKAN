...
def prepare_model(logger, num_grids, lr, l):
    ...
    if cfg["layer"] == 1:
        model = FourierKAN_Predictor([512, 1], cfg["mode"], num_grids) # change this to your model
    elif cfg["layer"] == 2:
        model = FourierKAN_Predictor([512, 512, 1], cfg["mode"], num_grids)
    elif cfg["layer"] == 3:
        model = FourierKAN_Predictor([512, 512, 512, 1], cfg["mode"], num_grids)
    else:
