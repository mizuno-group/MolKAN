...
class MLP_predictor(nn.Module):
    def __init__(self, width:list, device, working_dir:Path, results_dir_name:str, mode, LOGGER):
    ...
    def train(self, tr_loader, val_loader, lr, lamb,
              reg_metric="edge_forward_spline_n", lamb_l1=1., lamb_entropy=1., lamb_coefdiff=0., lamb_coef=0., test=False, fold_idx=None):
