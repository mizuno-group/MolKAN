...
from ..layers import *
from ..utils import fix_seed, plot_progress, BCELoss, MSE, Metrics
...
class KAN_Tuner:
    ...
    def _make_objective(self):
        ...
        def objective(trial):
            ...
            # prepare DataLoader
            trainloader = prep_dataloader(self.train_ds, batch_size, shuffle=True, num_workers=8, pin_memory=True)
            validloader = prep_dataloader(self.valid_ds, batch_size, shuffle=True, num_workers=8, pin_memory=True)
    ...
    def optimize_and_test(self):
        ...
        plot_progress(os.path.join(self.outdir, "plots"), best_trial.user_attrs["train_losses"], best_trial.user_attrs["valid_losses"], 50, note=self.note)
        ...
        fix_seed(self.seed)
        # prepare testloader
        testloader = prep_dataloader(self.test_ds, best_params["batch_size"], shuffle=True, num_workers=8, pin_memory=True)
        # prepare model
